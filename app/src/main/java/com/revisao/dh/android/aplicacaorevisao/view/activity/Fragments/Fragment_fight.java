 ...
 */
public class Fragment_fight extends Fragment implements ClickListener {

    List<ModelTemp> lista;
    public Fragment_fight() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_fragment_fight, container, false);
